...
from backend.dobot_xtrainer.robomimic_r2d2.robomimic import DATASET_REGISTRY
                        ...
                        if hdf5_type in download_hdf5_types:
                            ...
                            if url is None:
                                print(
                                    ...
                                    + " Create this dataset locally by running the appropriate command from backend.dobot_xtrainer.robomimic_r2d2.robomimic/scripts/extract_obs_from_raw_datasets.sh."
                                )
                                continue
                            if args.dry_run:
