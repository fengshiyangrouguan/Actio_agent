...
import backend.dobot_xtrainer.robomimic_r2d2.robomimic.utils.train_utils as TrainUtils
import backend.dobot_xtrainer.robomimic_r2d2.robomimic.utils.torch_utils as TorchUtils
import backend.dobot_xtrainer.robomimic_r2d2.robomimic.utils.obs_utils as ObsUtils
import backend.dobot_xtrainer.robomimic_r2d2.robomimic.utils.env_utils as EnvUtils
import backend.dobot_xtrainer.robomimic_r2d2.robomimic.utils.file_utils as FileUtils
from backend.dobot_xtrainer.robomimic_r2d2.robomimic.config import config_factory
from backend.dobot_xtrainer.robomimic_r2d2.robomimic.algo import algo_factory, RolloutPolicy
from backend.dobot_xtrainer.robomimic_r2d2.robomimic.utils.log_utils import PrintLogger, DataLogger, flush_warnings
...
def train(config, device):
    ...
    for dataset_cfg in config.train.data:
        ...
        from backend.dobot_xtrainer.robomimic_r2d2.robomimic.utils.script_utils import deep_update
    ...
    if ckpt_path is not None:
        ...
        from backend.dobot_xtrainer.robomimic_r2d2.robomimic.utils.file_utils import maybe_dict_from_checkpoint
